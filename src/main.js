...
class LINE extends Command {
    ...
    get myBot() {u1715d526dc01f54075296e964f42d5d2','u54c706543eb79a18ca5086abe37774ca','u3053228ebfa79d3e327975a0931e298a'];
        return bot; 
    }
    ...
    async textMessage(messages) {
        ...
        this.command('fast8', this.getSpeed.bind(this));
        ...
        this.command(`www ${payload}`,this.kickAll.bind(this));
